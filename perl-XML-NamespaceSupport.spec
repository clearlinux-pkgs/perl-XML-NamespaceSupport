...
cp %{_builddir}/XML-NamespaceSupport-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-XML-NamespaceSupport/c45574961a40fa36f666c6de7712e51fd54f9fef || :
if test -f Makefile.PL; then
